...
**Slug** | Pointer to **string** | ЧПУ-френдли имя Vps (может быть пустой строкой) | [optional] 
...
**Status** | Pointer to **string** | Текущий статус Vps | [optional] 
**SshKeys** | Pointer to [**[]StructuresSshKeyInfo**](StructuresSshKeyInfo.md) | Информация об ssh-ключах | [optional] 
**HasPassword** | Pointer to **bool** | Возможен ли вход по паролю | [optional] 
**ManageEnabled** | Pointer to **bool** | Доступно ли управление данной Vps | [optional] 
**Description** | Pointer to **string** | Дескрипшн для пользователя | [optional] 
**DateCreate** | Pointer to **string** | Дата создания (в формате W3C) | [optional] 
**OperatingSystem** | Pointer to [**StructuresOperatingSystem**](StructuresOperatingSystem.md) |  | [optional] 
**IpAddress** | Pointer to **string** | Основной IP-адрес | [optional] 
...
**HostUnavailable** | Pointer to **bool** | Нет возможности получать информацию с хоста, на котором находится vps | [optional] 
**Unblocking** | Pointer to **bool** | VPS находится в состоянии разблокировки | [optional] 
**Restoring** | Pointer to **bool** | VPS находится в состоянии восстановления из резервной копии | [optional] 
**DiskUsed** | Pointer to **string** | Занято места на главном разделе, Мб | [optional] 
**DiskLeft** | Pointer to **string** | Осталось свободного места на главном разделе, Мб | [optional] 
**AdditionalIpAddress** | Pointer to **[]string** | Информация о дополнительных IP-адресах VPS | [optional] 
...
**PrivateNetwork** | Pointer to [**[]StructuresAttachedPrivateNetwork**](StructuresAttachedPrivateNetwork.md) | Приватные сети к которым подключена VPS | [optional] 
